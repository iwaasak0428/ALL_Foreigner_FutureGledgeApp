            ...
            <main className="p-6">
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="mb-8 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                            <Badge variant="secondary" className="gap-1 pl-1">
                                <span className="rounded-full bg-white p-0.5"><Globe className="h-3 w-3" /></span>
                                特定技能1号
                                <button className="ml-1 hover:text-slate-900">×</button>
                            </Badge>
                            <Badge variant="secondary" className="gap-1 pl-1">
                                <span className="rounded-full bg-white p-0.5"><MapPin className="h-3 w-3" /></span>
                                関東エリア
                                <button className="ml-1 hover:text-slate-900">×</button>
                            </Badge>
                        </div>
                    ...
                    <div className="grid gap-6 lg:grid-cols-12">
                        {/* Left Column: Job Seekers (Talent) */}
                        ...
                        {/* Right Column: Jobs & Recommendations */}
                        <div className="lg:col-span-4 space-y-6">
                            ...
                            {/* Sending Agency Comparison Hint */}
        ...
        <div className="group relative flex flex-col gap-4 rounded-xl border border-slate-200 bg-white p-5 transition-all hover:border-brand-200 hover:shadow-md sm:flex-row sm:items-start">
            ...
            <div className="flex-1">
                ...
                <div className="flex items-center justify-between border-t border-slate-100 pt-3">
                    <span className={`text-xs font-semibold px-2 py-1 rounded ${status === '求職中' ? 'bg-emerald-50 text-emerald-600' : 'bg-amber-50 text-amber-600'}`}>
                        {status}
                    </span>
